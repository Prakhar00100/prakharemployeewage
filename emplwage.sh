	...
	//Main Function
     public static void main(String[] args) {
	    ...
	    System.out.println("Please Enter your choice to show Company Monthly Total Wage ");
            ...
            System.out.println("2:For Deloite ");
            System.out.println("3:For Barclays");
